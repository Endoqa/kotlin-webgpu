...
public fun interface WGPUProcRenderPassEncoderDrawIndexedIndirect {
    public fun invoke(
    ...
    public companion object {
        ...
        public val invokeHandle: MethodHandle =
            MethodHandles.lookup().unreflect(WGPUProcRenderPassEncoderDrawIndexedIndirect::class.java.methods.find {
                it.name == "invoke"
            }
            )
