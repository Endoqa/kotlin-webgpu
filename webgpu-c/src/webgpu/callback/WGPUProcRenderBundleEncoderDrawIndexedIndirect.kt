...
public fun interface WGPUProcRenderBundleEncoderDrawIndexedIndirect {
    public fun invoke(
    ...
    public companion object {
        ...
        public val invokeHandle: MethodHandle =
            MethodHandles.lookup().unreflect(WGPUProcRenderBundleEncoderDrawIndexedIndirect::class.java.methods.find {
                it.name == "invoke"
            }
            )
