...
public fun interface WGPUProcComputePassEncoderDispatchWorkgroups {
    public fun invoke(
    ...
    public companion object {
        ...
        public val invokeHandle: MethodHandle =
            MethodHandles.lookup().unreflect(WGPUProcComputePassEncoderDispatchWorkgroups::class.java.methods.find {
                it.name == "invoke"
            }
            )
