...
public fun interface WGPUProcRenderBundleEncoderDrawIndirect {
    public fun invoke(
    ...
    public companion object {
        ...
        public val invokeHandle: MethodHandle =
            MethodHandles.lookup().unreflect(WGPUProcRenderBundleEncoderDrawIndirect::class.java.methods.find {
                it.name == "invoke"
            }
            )
