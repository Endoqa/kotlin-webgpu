...
public value class WGPUShaderModuleWGSLDescriptor(
    ...
    public var chain: WGPUChainedStruct
        get() = WGPUChainedStruct(
            WGPUShaderModuleWGSLDescriptor.chainHandle.invokeExact(
                this.`$mem`,
                0L
            ) as MemorySegment
        )
    ...
    public var code: Pointer<Byte>
        get() = WGPUShaderModuleWGSLDescriptor.codeHandle.get(this.`$mem`, 0L) as MemorySegment
        set(`value`) {
            WGPUShaderModuleWGSLDescriptor.codeHandle.set(this.`$mem`, 0L, value)
        }

    public constructor(gc: Boolean) : this(kotlin.run {
        require(gc) { "Do not call this if gc is not want" }
        Arena.ofAuto().allocate(WGPUShaderModuleWGSLDescriptor.layout)
    })
    ...
    public companion object {
        ...
        public fun allocate(alloc: SegmentAllocator): WGPUShaderModuleWGSLDescriptor =
            WGPUShaderModuleWGSLDescriptor(alloc.allocate(WGPUShaderModuleWGSLDescriptor.layout))
    }
}
