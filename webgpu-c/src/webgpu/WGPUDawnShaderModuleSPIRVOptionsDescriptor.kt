...
public value class WGPUDawnShaderModuleSPIRVOptionsDescriptor(
    ...
    public var chain: WGPUChainedStruct
        get() =
            WGPUChainedStruct(
                WGPUDawnShaderModuleSPIRVOptionsDescriptor.chainHandle.invokeExact(
                    this.`$mem`,
                    0L
                ) as MemorySegment
            )
    ...
    public var allowNonUniformDerivatives: WGPUBool
        get() =
            (WGPUDawnShaderModuleSPIRVOptionsDescriptor.allowNonUniformDerivativesHandle.get(
                this.`$mem`,
                0L
            ) as Int).toUInt()
        set(`value`) {
            WGPUDawnShaderModuleSPIRVOptionsDescriptor.allowNonUniformDerivativesHandle.set(
                this.`$mem`,
                0L, value.toInt()
            )
        }
    ...
    public constructor(gc: Boolean) : this(kotlin.run {
        ...
        Arena.ofAuto().allocate(WGPUDawnShaderModuleSPIRVOptionsDescriptor.layout)
    })
    ...
    public companion object {
        ...
        public fun allocate(alloc: SegmentAllocator): WGPUDawnShaderModuleSPIRVOptionsDescriptor =
            WGPUDawnShaderModuleSPIRVOptionsDescriptor(alloc.allocate(WGPUDawnShaderModuleSPIRVOptionsDescriptor.layout))
    }
}
