...
public value class WGPUDepthStencilState(
    ...
    public var depthWriteEnabled: WGPUBool
        get() = (WGPUDepthStencilState.depthWriteEnabledHandle.get(this.`$mem`, 0L) as Int).toUInt()
        set(`value`) {
            WGPUDepthStencilState.depthWriteEnabledHandle.set(this.`$mem`, 0L, value.toInt())
        }
