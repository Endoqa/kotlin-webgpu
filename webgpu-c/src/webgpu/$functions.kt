...
public fun wgpuBufferGetUsage(buffer: WGPUBuffer): WGPUBufferUsageFlags =
    (`wgpuBufferGetUsage$mh`.invokeExact(buffer) as Int).toUInt()
...
public fun wgpuBufferMapAsync(
    ...
    `wgpuBufferMapAsync$mh`.invokeExact(buffer, mode.toInt(), offset.toLong(), size.toLong(), callback, userdata)
            as Unit
...
public fun wgpuDeviceGetSupportedSurfaceUsage(device: WGPUDevice, surface: WGPUSurface):
        WGPUTextureUsageFlags = (`wgpuDeviceGetSupportedSurfaceUsage$mh`.invokeExact(device, surface) as
        Int).toUInt()
...
public fun wgpuSharedBufferMemoryBeginAccess(
    ...
    (`wgpuSharedBufferMemoryBeginAccess$mh`.invokeExact(sharedBufferMemory, buffer, descriptor) as
            Int).toUInt()
...
public fun wgpuSharedBufferMemoryEndAccess(
    ...
    (`wgpuSharedBufferMemoryEndAccess$mh`.invokeExact(sharedBufferMemory, buffer, descriptor) as
            Int).toUInt()
...
public fun wgpuSharedTextureMemoryBeginAccess(
    ...
    (`wgpuSharedTextureMemoryBeginAccess$mh`.invokeExact(sharedTextureMemory, texture, descriptor) as
            Int).toUInt()
...
public fun wgpuSharedTextureMemoryEndAccess(
    ...
    (`wgpuSharedTextureMemoryEndAccess$mh`.invokeExact(sharedTextureMemory, texture, descriptor) as
            Int).toUInt()
...
public fun wgpuTextureGetUsage(texture: WGPUTexture): WGPUTextureUsageFlags =
    (`wgpuTextureGetUsage$mh`.invokeExact(texture) as Int).toUInt()
