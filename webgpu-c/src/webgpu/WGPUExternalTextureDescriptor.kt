...
public value class WGPUExternalTextureDescriptor(
    ...
    public var nextInChain: Pointer<WGPUChainedStruct>
        get() = WGPUExternalTextureDescriptor.nextInChainHandle.get(this.`$mem`, 0L) as MemorySegment
        set(`value`) {
            WGPUExternalTextureDescriptor.nextInChainHandle.set(this.`$mem`, 0L, value)
        }

    public var label: Pointer<Byte>
        get() = WGPUExternalTextureDescriptor.labelHandle.get(this.`$mem`, 0L) as MemorySegment
        set(`value`) {
            WGPUExternalTextureDescriptor.labelHandle.set(this.`$mem`, 0L, value)
        }

    public var plane0: WGPUTextureView
        get() = WGPUExternalTextureDescriptor.plane0Handle.get(this.`$mem`, 0L) as MemorySegment
        set(`value`) {
            WGPUExternalTextureDescriptor.plane0Handle.set(this.`$mem`, 0L, value)
        }

    public var plane1: WGPUTextureView
        get() = WGPUExternalTextureDescriptor.plane1Handle.get(this.`$mem`, 0L) as MemorySegment
        set(`value`) {
            WGPUExternalTextureDescriptor.plane1Handle.set(this.`$mem`, 0L, value)
        }

    public var visibleOrigin: WGPUOrigin2D
        get() = WGPUOrigin2D(
            WGPUExternalTextureDescriptor.visibleOriginHandle.invokeExact(
                this.`$mem`,
                0L
            ) as MemorySegment
        )
    ...
    public var visibleSize: WGPUExtent2D
        get() = WGPUExtent2D(
            WGPUExternalTextureDescriptor.visibleSizeHandle.invokeExact(
                this.`$mem`,
                0L
            ) as MemorySegment
        )
    ...
    public var doYuvToRgbConversionOnly: WGPUBool
        get() = (WGPUExternalTextureDescriptor.doYuvToRgbConversionOnlyHandle.get(this.`$mem`, 0L) as
                Int).toUInt()
        set(`value`) {
            WGPUExternalTextureDescriptor.doYuvToRgbConversionOnlyHandle.set(
                this.`$mem`,
                0L, value.toInt()
            )
        }
    ...
    public var yuvToRgbConversionMatrix: Pointer<Float>
        get() = WGPUExternalTextureDescriptor.yuvToRgbConversionMatrixHandle.get(this.`$mem`, 0L) as
                MemorySegment
        set(`value`) {
            WGPUExternalTextureDescriptor.yuvToRgbConversionMatrixHandle.set(this.`$mem`, 0L, value)
        }

    public var srcTransferFunctionParameters: Pointer<Float>
        get() = WGPUExternalTextureDescriptor.srcTransferFunctionParametersHandle.get(this.`$mem`, 0L)
                as MemorySegment
        set(`value`) {
            WGPUExternalTextureDescriptor.srcTransferFunctionParametersHandle.set(this.`$mem`, 0L, value)
        }

    public var dstTransferFunctionParameters: Pointer<Float>
        get() = WGPUExternalTextureDescriptor.dstTransferFunctionParametersHandle.get(this.`$mem`, 0L)
                as MemorySegment
        set(`value`) {
            WGPUExternalTextureDescriptor.dstTransferFunctionParametersHandle.set(this.`$mem`, 0L, value)
        }

    public var gamutConversionMatrix: Pointer<Float>
        get() = WGPUExternalTextureDescriptor.gamutConversionMatrixHandle.get(this.`$mem`, 0L) as
                MemorySegment
        set(`value`) {
            WGPUExternalTextureDescriptor.gamutConversionMatrixHandle.set(this.`$mem`, 0L, value)
        }

    public var mirrored: WGPUBool
        get() = (WGPUExternalTextureDescriptor.mirroredHandle.get(this.`$mem`, 0L) as Int).toUInt()
        set(`value`) {
            WGPUExternalTextureDescriptor.mirroredHandle.set(this.`$mem`, 0L, value.toInt())
        }

    public var rotation: WGPUExternalTextureRotation
        get() =
            WGPUExternalTextureRotation.fromInt(
                WGPUExternalTextureDescriptor.rotationHandle.get(
                    this.`$mem`,
                    0L
                ) as Int
            )
        set(`value`) {
            WGPUExternalTextureDescriptor.rotationHandle.set(this.`$mem`, 0L, value.value)
        }

    public constructor(gc: Boolean) : this(kotlin.run {
        require(gc) { "Do not call this if gc is not want" }
        Arena.ofAuto().allocate(WGPUExternalTextureDescriptor.layout)
    })
    ...
    public companion object {
        ...
        public fun allocate(alloc: SegmentAllocator): WGPUExternalTextureDescriptor =
            WGPUExternalTextureDescriptor(alloc.allocate(WGPUExternalTextureDescriptor.layout))
    }
}
