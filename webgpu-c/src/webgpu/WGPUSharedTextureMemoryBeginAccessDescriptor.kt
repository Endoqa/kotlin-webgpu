...
public value class WGPUSharedTextureMemoryBeginAccessDescriptor(
    ...
    public var concurrentRead: WGPUBool
        get() = (concurrentReadHandle.get(this.`$mem`, 0L)
                as Int).toUInt()
        set(`value`) {
            concurrentReadHandle.set(
                this.`$mem`,
                0L, value.toInt()
            )
        }
    ...
    public var signaledValues: Pointer<uint64_t>
        get() = signaledValuesHandle.get(this.`$mem`, 0L)
                as MemorySegment
        set(`value`) {
    ...
    public companion object {
        ...
        public fun allocate(alloc: SegmentAllocator): WGPUSharedTextureMemoryBeginAccessDescriptor =
            WGPUSharedTextureMemoryBeginAccessDescriptor(alloc.allocate(layout))
    }
}
