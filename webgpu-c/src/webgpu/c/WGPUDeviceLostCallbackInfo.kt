...
public value class WGPUDeviceLostCallbackInfo(
    ...
    public var callback: WGPUDeviceLostCallback
    ...
    public var userdata1: Pointer<Unit>
        get() = WGPUDeviceLostCallbackInfo.userdata1Handle.get(this.`$mem`, 0L) as MemorySegment
        set(`value`) {
            WGPUDeviceLostCallbackInfo.userdata1Handle.set(this.`$mem`, 0L, value)
        }

    public var userdata2: Pointer<Unit>
        get() = WGPUDeviceLostCallbackInfo.userdata2Handle.get(this.`$mem`, 0L) as MemorySegment
        set(`value`) {
            WGPUDeviceLostCallbackInfo.userdata2Handle.set(this.`$mem`, 0L, value)
        }
