...
public value class WGPUCompilationInfoCallbackInfo(
    ...
    public var userdata1: Pointer<Unit>
        get() = WGPUCompilationInfoCallbackInfo.userdata1Handle.get(this.`$mem`, 0L) as MemorySegment
        set(`value`) {
            WGPUCompilationInfoCallbackInfo.userdata1Handle.set(this.`$mem`, 0L, value)
        }

    public var userdata2: Pointer<Unit>
        get() = WGPUCompilationInfoCallbackInfo.userdata2Handle.get(this.`$mem`, 0L) as MemorySegment
        set(`value`) {
            WGPUCompilationInfoCallbackInfo.userdata2Handle.set(this.`$mem`, 0L, value)
        }
