...
@JvmInline
public value class WGPUSurfaceDescriptorFromXcbWindow(
    ...
    public var connection: Pointer<Unit>
        get() = connectionHandle.get(this.`$mem`, 0L) as
                MemorySegment
        set(`value`) {
            connectionHandle.set(this.`$mem`, 0L, value)
        }

    public var window: uint32_t
    ...
    public companion object {
        ...
        @JvmStatic
        public fun allocate(alloc: SegmentAllocator): WGPUSurfaceDescriptorFromXcbWindow =
            WGPUSurfaceDescriptorFromXcbWindow(alloc.allocate(layout))
    }
}
