...
public value class WGPUDrmFormatCapabilities(
    ...
    public var propertiesCount: ULong
        get() = (propertiesCountHandle.get(this.`$mem`, 0L) as Long).toULong()
        set(`value`) {
            propertiesCountHandle.set(this.`$mem`, 0L, value.toLong())
        }

    public var properties: Pointer<WGPUDrmFormatProperties>
        get() = propertiesHandle.get(this.`$mem`, 0L) as MemorySegment
        set(`value`) {
            propertiesHandle.set(this.`$mem`, 0L, value)
        }
    ...
    public companion object {
        ...
        public fun allocate(alloc: SegmentAllocator): WGPUDrmFormatCapabilities =
            WGPUDrmFormatCapabilities(alloc.allocate(layout))
    }
}
