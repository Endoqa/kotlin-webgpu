...
public value class WGPUImageCopyExternalTexture(
    ...
    public var nextInChain: Pointer<WGPUChainedStruct>
        get() = WGPUImageCopyExternalTexture.nextInChainHandle.get(this.`$mem`, 0L) as MemorySegment
        set(`value`) {
            WGPUImageCopyExternalTexture.nextInChainHandle.set(this.`$mem`, 0L, value)
        }

    public var externalTexture: WGPUExternalTexture
        get() = WGPUImageCopyExternalTexture.externalTextureHandle.get(this.`$mem`, 0L) as MemorySegment
        set(`value`) {
            WGPUImageCopyExternalTexture.externalTextureHandle.set(this.`$mem`, 0L, value)
        }

    public var origin: WGPUOrigin3D
        get() = WGPUOrigin3D(
            WGPUImageCopyExternalTexture.originHandle.invokeExact(this.`$mem`, 0L) as
                    MemorySegment
        )
        set(`value`) {
    ...
    public var naturalSize: WGPUExtent2D
        get() = WGPUExtent2D(
            WGPUImageCopyExternalTexture.naturalSizeHandle.invokeExact(this.`$mem`, 0L)
                    as MemorySegment
        )
        set(`value`) {
            MemorySegment.copy(
    ...
    public constructor(gc: Boolean) : this(kotlin.run {
        ...
        Arena.ofAuto().allocate(WGPUImageCopyExternalTexture.layout)
    })
    ...
    public companion object {
        ...
        public fun allocate(alloc: SegmentAllocator): WGPUImageCopyExternalTexture =
            WGPUImageCopyExternalTexture(alloc.allocate(WGPUImageCopyExternalTexture.layout))
    }
}
