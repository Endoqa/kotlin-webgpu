...
public value class WGPUExternalTextureBindingLayout(
    ...
    public var chain: WGPUChainedStruct
        get() = WGPUChainedStruct(
            WGPUExternalTextureBindingLayout.chainHandle.invokeExact(
                this.`$mem`,
                0L
            ) as MemorySegment
        )
    ...
    public constructor(gc: Boolean) : this(kotlin.run {
        ...
        Arena.ofAuto().allocate(WGPUExternalTextureBindingLayout.layout)
    })
    ...
    public companion object {
        ...
        public fun allocate(alloc: SegmentAllocator): WGPUExternalTextureBindingLayout =
            WGPUExternalTextureBindingLayout(alloc.allocate(WGPUExternalTextureBindingLayout.layout))
    }
}
