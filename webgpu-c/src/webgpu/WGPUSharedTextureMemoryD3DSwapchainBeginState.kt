...
public value class WGPUSharedTextureMemoryD3DSwapchainBeginState(
    ...
    public var chain: WGPUChainedStruct
        get() =
            WGPUChainedStruct(
                WGPUSharedTextureMemoryD3DSwapchainBeginState.chainHandle.invokeExact(
                    this.`$mem`,
                    0L
                ) as MemorySegment
            )
    ...
    public var isSwapchain: WGPUBool
        get() = (WGPUSharedTextureMemoryD3DSwapchainBeginState.isSwapchainHandle.get(this.`$mem`, 0L) as
                Int).toUInt()
        set(`value`) {
            WGPUSharedTextureMemoryD3DSwapchainBeginState.isSwapchainHandle.set(
                this.`$mem`,
                0L, value.toInt()
            )
        }
    ...
    public constructor(gc: Boolean) : this(kotlin.run {
        ...
        Arena.ofAuto().allocate(WGPUSharedTextureMemoryD3DSwapchainBeginState.layout)
    })
    ...
    public companion object {
        ...
        public fun allocate(alloc: SegmentAllocator): WGPUSharedTextureMemoryD3DSwapchainBeginState =
            WGPUSharedTextureMemoryD3DSwapchainBeginState(alloc.allocate(WGPUSharedTextureMemoryD3DSwapchainBeginState.layout))
    }
}
