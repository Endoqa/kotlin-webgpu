...
public value class WGPURenderBundleEncoderDescriptor(
    ...
    public var nextInChain: Pointer<WGPUChainedStruct>
        get() = WGPURenderBundleEncoderDescriptor.nextInChainHandle.get(this.`$mem`, 0L) as
                MemorySegment
        set(`value`) {
            WGPURenderBundleEncoderDescriptor.nextInChainHandle.set(this.`$mem`, 0L, value)
        }

    public var label: Pointer<Byte>
        get() = WGPURenderBundleEncoderDescriptor.labelHandle.get(this.`$mem`, 0L) as MemorySegment
        set(`value`) {
            WGPURenderBundleEncoderDescriptor.labelHandle.set(this.`$mem`, 0L, value)
        }

    public var colorFormatCount: ULong
        get() = (WGPURenderBundleEncoderDescriptor.colorFormatCountHandle.get(this.`$mem`, 0L) as
                Long).toULong()
        set(`value`) {
            WGPURenderBundleEncoderDescriptor.colorFormatCountHandle.set(this.`$mem`, 0L, value.toLong())
        }

    public var colorFormats: Pointer<WGPUTextureFormat>
        get() = WGPURenderBundleEncoderDescriptor.colorFormatsHandle.get(this.`$mem`, 0L) as
                MemorySegment
        set(`value`) {
            WGPURenderBundleEncoderDescriptor.colorFormatsHandle.set(this.`$mem`, 0L, value)
        }

    public var depthStencilFormat: WGPUTextureFormat
        get() =
            WGPUTextureFormat.fromInt(
                WGPURenderBundleEncoderDescriptor.depthStencilFormatHandle.get(
                    this.`$mem`,
                    0L
                ) as Int
            )
        set(`value`) {
            WGPURenderBundleEncoderDescriptor.depthStencilFormatHandle.set(this.`$mem`, 0L, value.value)
        }

    public var sampleCount: uint32_t
        get() = (WGPURenderBundleEncoderDescriptor.sampleCountHandle.get(this.`$mem`, 0L) as
                Int).toUInt()
        set(`value`) {
            WGPURenderBundleEncoderDescriptor.sampleCountHandle.set(this.`$mem`, 0L, value.toInt())
        }

    public var depthReadOnly: WGPUBool
        get() = (WGPURenderBundleEncoderDescriptor.depthReadOnlyHandle.get(this.`$mem`, 0L) as
                Int).toUInt()
        set(`value`) {
            WGPURenderBundleEncoderDescriptor.depthReadOnlyHandle.set(this.`$mem`, 0L, value.toInt())
        }

    public var stencilReadOnly: WGPUBool
        get() = (WGPURenderBundleEncoderDescriptor.stencilReadOnlyHandle.get(this.`$mem`, 0L) as
                Int).toUInt()
        set(`value`) {
            WGPURenderBundleEncoderDescriptor.stencilReadOnlyHandle.set(this.`$mem`, 0L, value.toInt())
        }

    public constructor(gc: Boolean) : this(kotlin.run {
        require(gc) { "Do not call this if gc is not want" }
        Arena.ofAuto().allocate(WGPURenderBundleEncoderDescriptor.layout)
    })
    ...
    public companion object {
        ...
        public fun allocate(alloc: SegmentAllocator): WGPURenderBundleEncoderDescriptor =
            WGPURenderBundleEncoderDescriptor(alloc.allocate(WGPURenderBundleEncoderDescriptor.layout))
    }
}
