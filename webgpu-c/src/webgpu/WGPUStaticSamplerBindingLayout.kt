...
public value class WGPUStaticSamplerBindingLayout(
    ...
    public var chain: WGPUChainedStruct
        get() = WGPUChainedStruct(
            WGPUStaticSamplerBindingLayout.chainHandle.invokeExact(
                this.`$mem`,
                0L
            ) as MemorySegment
        )
    ...
    public var sampler: WGPUSampler
        get() = WGPUStaticSamplerBindingLayout.samplerHandle.get(this.`$mem`, 0L) as MemorySegment
        set(`value`) {
            WGPUStaticSamplerBindingLayout.samplerHandle.set(this.`$mem`, 0L, value)
        }

    public constructor(gc: Boolean) : this(kotlin.run {
        require(gc) { "Do not call this if gc is not want" }
        Arena.ofAuto().allocate(WGPUStaticSamplerBindingLayout.layout)
    })
    ...
    public companion object {
        ...
        public fun allocate(alloc: SegmentAllocator): WGPUStaticSamplerBindingLayout =
            WGPUStaticSamplerBindingLayout(alloc.allocate(WGPUStaticSamplerBindingLayout.layout))
    }
}
