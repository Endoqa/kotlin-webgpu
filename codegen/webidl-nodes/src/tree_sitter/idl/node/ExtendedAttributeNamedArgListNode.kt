...
public class ExtendedAttributeNamedArgListNode(
  ...
  public val arguments: ArgumentListNode
    get() = ArgumentListNode(`$node`.getChildByFieldName("arguments") ?:
        error("required field arguments is null"))

  public val identifier: IdentifierNode
    get() = IdentifierNode(`$node`.getChildByFieldName("identifier") ?:
        error("required field identifier is null"))
