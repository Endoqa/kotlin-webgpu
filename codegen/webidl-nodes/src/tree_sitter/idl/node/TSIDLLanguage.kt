...
public class TSIDLLanguage(
    ...
    public val callback_interface_members: UShort = lang.idForNodeKind(
    ...
    public val extended_attribute_arg_list: UShort = lang.idForNodeKind(
    ...
    public val extended_attribute_no_args: UShort = lang.idForNodeKind(
